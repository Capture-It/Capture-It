...
class AboutUS extends React.Component {
    render() {
        return (
            ...
            <p className='head' style ={{fontSize: '20px'}} >Capture-It is a website for talented Photographers, offering them a platform for sharing and storing photos with photographers</p>
                 <hr></hr>
                 <h2>Our Team</h2>
            <p className='head'></p>
